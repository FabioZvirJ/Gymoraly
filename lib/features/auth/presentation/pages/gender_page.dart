      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: isSelected ? const Color(0xFF2196F3) : Colors.grey.shade300, width: isSelected ? 2.0 : 1.0),
          ),
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(icon, size: 70, color: iconColor),
            const SizedBox(height: 16),
            Text(title, style: TextStyle(fontSize: 18, fontWeight: isSelected ? FontWeight.w600 : FontWeight.w500, color: Colors.black87)),
          ]),
        ),
      ),
    );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Seu Sexo', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: Colors.black87)),
              const SizedBox(height: 50),
              Row(children: [
                _buildGenderCard(title: 'Masculino', icon: Icons.male, iconColor: const Color(0xFF2196F3), genderValue: 'male'),
                const SizedBox(width: 20),
                _buildGenderCard(title: 'Feminino', icon: Icons.female, iconColor: const Color(0xFFAD5287), genderValue: 'female'),
              ]),
              const Spacer(),
              Row(children: [
                Expanded(
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: selectedGender == null ? null : () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => PhysicalDataPage(controller: widget.controller)));
                    },
