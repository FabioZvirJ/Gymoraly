...
class _AddWorkoutViewState extends State<AddWorkoutView> {
  ...
  Future<void> _fetchExercisesFromApi() async {
    ...
    try {
      final url = Uri.parse(
        'https://exercisedb.dev/api/v1/exercises?limit=100',
      );
      ...
      debugPrint("Erro ao buscar na API: $e");
    }
  }
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: Image.network(
                ...
                fit: BoxFit
                    .contain, // Ajusta o GIF para caber certinho sem cortar
  ...
  Widget _buildExerciseCard(dynamic exercise, Color primaryColor) {
    ...
    String nomeExercicio = nomeCru.isNotEmpty
        ? nomeCru[0].toUpperCase() + nomeCru.substring(1)
        : 'Exercício sem nome';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          MouseRegion(
            cursor:
                SystemMouseCursors.click, // Aparece a mãozinha no Windows/Web
